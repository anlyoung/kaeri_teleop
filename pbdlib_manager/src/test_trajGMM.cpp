...
int main(int argc, char **argv)
{
	...
	for(uint i = 1 ; i <= nbSamples ; i++)
	{
		...
		convert.str("");
		convert << i;
		posDataPath = basePath + commonPath + convert.str() + ".txt";
	...
	std::string muPath 		  =	basePath + "data/trajgmm/TrajGMM_test_mu.txt";
	std::string sigmaPath     = basePath + "data/trajgmm/TrajGMM_test_sigma.txt";
	std::string priorsPath	  = basePath + "data/trajgmm/TrajGMM_test_priors.txt";
	std::string varNamesPath  = basePath + "data/trajgmm/TrajGMM_test_varnames.txt";
	std::string modelInfoPath =	basePath +  "data/trajgmm/TrajGMM_test_info.txt";
	std::string testGammaPath = basePath + "data/trajgmm/TrajGMM_test_Gamma.txt";
