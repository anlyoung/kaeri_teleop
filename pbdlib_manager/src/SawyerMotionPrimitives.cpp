#include "SawyerMotionPrimitives.h"
#include "spline.h"

// https://github.com/ros-industrial/cros/blob/master/resources/cros_testbed/src/std_msgs_talker.cpp

SawyerMotionPrimitives::SawyerMotionPrimitives(ros::NodeHandle* nodehandle)
    :nh_(*nodehandle)
{
    // constructor
    ROS_INFO("in class constructor of SawyerMotionPrimitives");
...
void SawyerMotionPrimitives::InitializeSubscribers()
{
    ROS_INFO("Initializing Subscribers");

	phantom_joint_sub = nh_.subscribe("/Phantom_joint_states", 1, &SawyerMotionPrimitives::PhantomJointCallback, this);

    // From the Unity
    unity_position_sub = nh_.subscribe("/MotionPrimitives/HandPoseStamped", 1, &SawyerMotionPrimitives::UnityRightHandControllerPositionCallback, this);
    unity_button_status_sub = nh_.subscribe("/MotionPrimitives/TimeRunning", 1, &SawyerMotionPrimitives::UnityRightHandControllerButtonStatusCallback, this);

	phantom_button_sub = nh_.subscribe("/Phantom_button_state", 1, &SawyerMotionPrimitives::PhantomButtonCallback, this);
    sawyer_joint_sub = nh_.subscribe("/robot/joint_states", 1, &SawyerMotionPrimitives::RobotJointCallback, this);
    sawyer_endpoint_sub = nh_.subscribe("/robot/limb/right/endpoint_state", 1, &SawyerMotionPrimitives::RobotEndPointCallback, this);
}

void SawyerMotionPrimitives::InitializePublishers()
{
    ROS_INFO("Initializing Publishers");
    trajgmm_posArr_pub = nh_.advertise<geometry_msgs::PoseArray>("/pbdlib_trajgmm_states", 1);
}

void SawyerMotionPrimitives::InitializeServices()
{
    ROS_INFO("Initializing Services");
    //minimal_service_ = nh_.advertiseService("exampleMinimalService", &ExampleRosClass::serviceCallback, this); 
}

void SawyerMotionPrimitives::UnityRightHandControllerPositionCallback(const geometry_msgs::Pose::ConstPtr &msg)
{
    curUnityData.X = msg->position.x;
    curUnityData.Y = msg->position.y;
    curUnityData.Z = msg->position.z;

    std::cout << "[UNITY] Pose (X) : " << msg->position.x << ", Pose (Y) : " << msg->position.y << std::endl;
}

void SawyerMotionPrimitives::UnityRightHandControllerButtonStatusCallback(const std_msgs::Int32 &msg)
{
...
void SawyerMotionPrimitives::PhantomJointCallback(const geometry_msgs::Pose::ConstPtr &msg)
{
...
void SawyerMotionPrimitives::PhantomButtonCallback(const std_msgs::String &msg)
{
...
void SawyerMotionPrimitives::RobotJointCallback(const sensor_msgs::JointState::ConstPtr &msg)
{

}

void SawyerMotionPrimitives::RobotEndPointCallback(const intera_core_msgs::EndpointState::ConstPtr &msg)
{
...
void SawyerMotionPrimitives::StartDemonstration()
{
...
void SawyerMotionPrimitives::TrainingPhantomData()
{
...
void SawyerMotionPrimitives::TrainingUnityData()
{
    if(curTrainDataType != RECORD_CURRENT_VIRTUAL_DATA)
        return;
...
void SawyerMotionPrimitives::MakeTrajectoryAlogrithm()
{
...
sRobotEndPointPose SawyerMotionPrimitives::GetCurRobotEndPos()
{
    ros::spinOnce();
    return m_vRobotEndPt;
}

sRobotEndPointPose SawyerMotionPrimitives::GetTargetRobotEndPos()
{
    return m_vRobotTargetEndPt;
}

sRobotEndPointPose SawyerMotionPrimitives::GetPrevRobotEndPos()
{
    return m_vRobotPrevPt;
}

sRobotEndPointTrajectory SawyerMotionPrimitives::GetPrevRobotEndTrajectories()
{
    return m_vRobotPrevTrajectories;
}

void SawyerMotionPrimitives::SendCmdMoveEndPointwithTrajectory()
{
...
void SawyerMotionPrimitives::SendCmdMove(sRobotEndPointPose pose)
{
...
void SawyerMotionPrimitives::SendCmdMoveDemoPosition()
{
...
void SawyerMotionPrimitives::SetMaxRepeatMotions(int nMaxVal)
{
    m_nMaxMotionCnt = nMaxVal;
}

void SawyerMotionPrimitives::SetDataSize(int nDataSize)
{
    curGMMparams.nbData = nDataSize;
}

void SawyerMotionPrimitives::SetSaveFile(bool bSave)
{
    m_bSaveFileFlag = bSave;
}

void SawyerMotionPrimitives::SetUseTestTrainDataFiles(int nType)
{
    m_bUseTestTrainDataFlag = false;
...
void SawyerMotionPrimitives::SetGMMParams(sGMMParams params)
{
...
void SawyerMotionPrimitives::SetGMMParams(int nbStates, int nbVarPos, int nbDeriv, double dt)
{
...
int SawyerMotionPrimitives::GetCurMotionCnt()
{
    return m_nCurMotionCnt;
}

sGMMParams SawyerMotionPrimitives::GetGMMParams()
{
    return curGMMparams;
}

bool SawyerMotionPrimitives::IsTraining()
{
